...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-65px)] flex items-center justify-center px-4 py-12">
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-96 h-96 bg-purple-500/8 rounded-full blur-3xl pointer-events-none" />
      ...
      <div ref={formRef} className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">
            Start detecting fake news with AI
          </p>
        </div>
